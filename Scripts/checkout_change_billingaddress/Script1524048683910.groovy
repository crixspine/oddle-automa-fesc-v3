...
WebUI.setText(findTestObject('checkout/input_billingAddressOne'), GlobalVariable.address_alternate)

WebUI.setText(findTestObject('checkout/input_billingAddressPostal'), GlobalVariable.postal_alternate)

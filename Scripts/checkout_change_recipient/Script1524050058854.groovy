...
WebUI.waitForElementVisible(findTestObject('checkout/label_Recipient information is'), 0)

WebUI.uncheck(findTestObject('checkout/label_Recipient information is'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('checkout/input_recipientName'), 0)

WebUI.setText(findTestObject('checkout/input_recipientName'), 'recipientNameChanged')

WebUI.setText(findTestObject('checkout/input_recipientContact'), '90009000')

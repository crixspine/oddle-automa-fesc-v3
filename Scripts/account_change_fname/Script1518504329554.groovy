...
WebUI.verifyElementText(findTestObject('accountSettings/span_FirstName-XPATH'), GlobalVariable.fname)
...
WebUI.waitForElementClickable(findTestObject('accountSettings/input_First Name'), 0)

WebUI.setText(findTestObject('accountSettings/input_First Name'), GlobalVariable.fname + 'test')
...
WebUI.verifyElementText(findTestObject('accountSettings/span_FirstName-XPATH'), GlobalVariable.fname + 'test')
...
WebUI.verifyElementText(findTestObject('logIn/span_signin_SignedIn Name'), (GlobalVariable.fname + 'test ') + GlobalVariable.lname)

WebUI.waitForElementVisible(findTestObject('accountSettings/div_signed header-btn user Hover On'), 0)

'Test complete and passed; change back to original fname'
WebUI.mouseOver(findTestObject('accountSettings/div_signed header-btn user Hover On'))
...
WebUI.setText(findTestObject('accountSettings/input_First Name'), GlobalVariable.fname)

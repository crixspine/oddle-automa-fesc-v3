...
'ensure promocode is unavailable'
WebUI.setText(findTestObject('checkout/input_promo-code-textbox'), 'invalidpromocode123')
...
WebUI.verifyElementPresent(findTestObject('checkout/i_fa fa-times promo-code-icon Error'), 0)

...
WebUI.setText(findTestObject('externalSites/input_pass_fbwindow'), 'wrongpassword')

WebUI.click(findTestObject('externalSites/label_loginbutton_fbwindow'))

WebUI.delay(1)

WebUI.verifyElementPresent(findTestObject('externalSites/div_error_box_fbwindow'), 0)
